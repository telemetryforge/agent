...
sed_wrapper -i "s/FLUENTDO_AGENT_VERSION=\${FLUENTDO_AGENT_VERSION:-.*$/FLUENTDO_AGENT_VERSION=\${FLUENTDO_AGENT_VERSION:-$NEW_FLUENTDO_AGENT_VERSION}/g" "$REPO_ROOT"/testing/bats/run-bats.sh
sed_wrapper -i "s/FLUENTDO_AGENT_VERSION=\${FLUENTDO_AGENT_VERSION:-.*$/FLUENTDO_AGENT_VERSION=\${FLUENTDO_AGENT_VERSION:-$NEW_FLUENTDO_AGENT_VERSION}/g" "$REPO_ROOT"/testing/bats/run-package-functional-tests.sh
